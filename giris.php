...
<body>
    <div class="wrapper">
        <form action="giris_islem.php" method="POST">
            ...
            <div class="input-box">
                    <input type="password" placeholder="Şifre" required name="password"><i class='bx bxs-lock-alt' ></i>
            </div>

            <div class="remember-forgot">
                <label><input type="checkbox" name="confrimPassword"> Beni Hatırla</label> <a href="#">Parolanızı mı Unuttunuz?</a>
            </div>
